...
function MergeSchool() {
  ...
  const initializeBoard = () => {
    ...
    setStep(0);
    setQs_ranking(32768);
    //document.getElementById("general-step-value").innerHTML = step;
    //document.getElementById("general-qs-ranking-value").innerHTML = qs_ranking;
  };
  ...
  return (
    <>
      <Header f={initializeBoard} />
      <Board2048 className="wrapper" board={board} />
      <div className="btn-groups">
        <div className="btn-useful" id="badend-btn" onClick={setBadEnd}>
          BadEnd
        </div>
        <div className="btn-useful" id="goodend-btn" onClick={setGoodEnd}>
          GoodEnd
        </div>
      </div>
    </>
