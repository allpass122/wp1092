...
function App() {
  ...
  const station_info =
    current_station_id[0] !== "N"
      ? data[station_type][parseInt(station_order) - 1]
      : null; // get certain station information
    ...
    return (
      <div className="wrapper">
        <div className="welcome-title">
          <h1>Welcome to MRT Distance Calculator !</h1>
        </div>
      </div>
    );
  }
    ...
    <div className="wrapper">
      ...
      <div className="calculator-container">
        <div className="mode-selector">
          ...
          <select id="start-select" className="start-station">
            {" "}
          ...
          <select id="end-select" className="end-station">
            {" "}
            {/* you should add both onChange and value to attributes */}
            <option></option>
            {
          ...
          <button onClick={calculateDistance} id="search-btn">
            查詢距離
          </button>
          <span id="answer">
            {" "}
            {/* you should add className to attributes */}
            {distance}
          </span>
