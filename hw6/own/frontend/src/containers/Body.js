...
const Body = () => {
  ...
  const handleAdd = async () => {
    ...
    console.log(msg);
    if (!newScoreCard) addErrorMessage(msg);
    else addCardMessage(msg);
  };

  const handleQuery = async () => {
    var cmp = document.getElementById("scoreSelect").value;
    const {
          ...
          <FormControl component="fieldset">
            ...
            >
              ...
              <FormControlLabel
                ...
                label="Score"
              />
              <select disabled={queryType !== "score"} id="scoreSelect">
